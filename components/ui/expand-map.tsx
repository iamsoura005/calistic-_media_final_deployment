...
export function LocationMap({
    ...
    return (
        ...
        >
                    ...
                    {isExpanded && (
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" fill="#facc15" />
                                    <circle cx="12" cy="9" r="2.5" className="fill-zinc-900" />
                                </svg>
                            </motion.div>
                ...
                <div className="relative z-10 h-full flex flex-col justify-between p-5">
                    <div className="flex items-start justify-between">
                        ...
                        >
                            ...
                            <span className="text-[10px] font-medium text-white/50 tracking-wide uppercase">Organic reach</span>
                        </motion.div>
                    </div>
                    ...
                    <div className="space-y-1">
                        ...
                        <motion.div
                            className="h-px bg-gradient-to-r from-yellow-500/50 via-yellow-400/30 to-transparent"
            ...
            <motion.p
                className="absolute -bottom-6 left-1/2 text-[10px] text-white/30 whitespace-nowrap uppercase tracking-widest"
                style={{ x: "-50%" }}
                initial={{ opacity: 0 }}
                animate={{
