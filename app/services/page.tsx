                            ...
                            >
                                <div className="space-y-8 flex flex-col items-center lg:items-start text-center lg:text-left">
                                    ...
                                    <motion.button
                                        ...
                                        onClick={() => window.open(`https://wa.me/918240721057?text=I'm%20interested%20in%20${encodeURIComponent(service.title)}`, "_blank")}
                                    >
                                        Inquire about {service.title} <ArrowRight className="w-4 h-4" />
                                    </motion.button>
                                    {service.title === "Organic Content Creation" && (
                                        <a
                                            href="https://wa.me/918240721057?text=I'd%20like%20a%20Free%20Strategy%20for%20Content%20Creation"
                                            target="_blank"
